...
import userInterface.FBI.fbiOrgWorkAreaJPanel;
...
public class FBIRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Network network, EcoSystem ecosystem) {
        return new fbiOrgWorkAreaJPanel(userProcessContainer, account, (FBI)organization, enterprise, network,ecosystem);
