 ...
 * @author root
 */
public class reportsNucJPanel extends javax.swing.JPanel {
    JFreeChart chart;
     ...
     */
    public reportsNucJPanel(JPanel userProcessContainer, UserAccount account, OfficeOfNuclearEnergyOrganization organization, Enterprise enterprise, Network network) {
        initComponents();
    ...
    private void barGraph(){
        ...
        "Office Of Nuclear Spendings", // Title
    ...
    XYSeries series = new XYSeries("Office Of Nuclear Spendings");
