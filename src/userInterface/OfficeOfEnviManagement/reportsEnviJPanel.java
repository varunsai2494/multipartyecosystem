 ...
 * @author root
 */
public class reportsEnviJPanel extends javax.swing.JPanel {
    JFreeChart chart;
     ...
     */
    public reportsEnviJPanel(JPanel userProcessContainer, UserAccount account, OfficeOfEnviManagementOrganization organization, Enterprise enterprise, Network network) {
        initComponents();
    ...
    private void barGraph(){
        ...
        "Office of environment Spendings", // Title
    ...
    XYSeries series = new XYSeries("Office of environment Spendings");
